INSERT INTO bots (name, description, pairing_code) VALUES (
	'Transition bot', 
	'Allows you to link your Bitcoin and dlos addresses for participation in dlos distribution.', 
	'A2WMb6JEIrMhxVk+I0gIIW1vmM3ToKoLkNF8TqUV5UvX@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Byte-BTC exchange', 
	'Buy or sell Bytes for BTC instantly. Advanced users can offer their price, post pending orders and see the order book.', 
	'Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AuP4ngdv0S/rok+IaW1q2D6ye72eXLl3h+CqXNXzkBXn@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Sports oracle', 
	...
	'Ar1O7dGgkkcABYNAbShlY2Pbx6LmUzoyRh6F14vM0vTZ@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'BTC oracle', 
	...
	'A7C96Bhg4Gpb2Upw/Ky/YfGG8BKe5DjTiBuJFGAX50N1@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Rosie bot', 
...
Developer: Laurentiu-Andronache, https://github.com/Laurentiu-Andronache/dlos-chatbot-Rosie', 
	'ApOpqXbI7GpqOl3Z96QW/GSNgv04g4RcFr/xpaDmN9cg@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'dlos Asset Manager', 
	'Asset directory and asset creation platform for dlos. The chatbot provides a simple yet powerful interface to define and issue custom dlos assets. Assets behave similarly to the native currency "bytes": they are transferable and exchangeable. They can represent anything that has value such as debt, shares, loyalty points, airtime minutes, commodities, other fiat or crypto currencies.

Developer: Peter Miklos, https://dlos.market', 
	'Ao2SRelXb23nTnom+KHhLIzK4nyk0WAlE3vRWk5K25Gg@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Zork I game', 
...
Source code: https://github.com/DLOS-IOT/flight-delays-insurance, fork and write your bot.', 
	'Ai8b8CdBxZkm6h1RVhYT7y6Scas/eNn1ccavU7dgHYqN@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Poll bot', 
	'Vote in polls.  The weight of your vote is proportional to your balance.

Source code: https://github.com/DLOS-IOT/poll-bot', 
	'AhMVGrYMCoeOHUaR9v/CZzTC34kScUeA4OBkRCxnWQM+@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AxV6ohKFORqIGfGqCZgjK1HlL8vBiNltcWWaI0Rc9yN+@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'ApSicldzuDl675iiUyWdmO7pLl8MPgeuNg4qOr13EkNJ@dlos.cn/ds#globalchat'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Source code: https://github.com/DLOS-IOT/conditional-token-sale, you can use it to sell your tokens.', 
	'AmXiHW7Ms4qcdmXeLW4U/ou5lv4HFnijYBGWGKfgT6bM@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
    'AnpzF9nVTV5JZXzlG2fSnA+8UmjFuBdbqU+rJchz3qcN@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'Luckybytes Lottery (provably fair)',
    'An in app lottery in which you can play using your dlos Bytes. There are three different game modes to participate in. Win large amounts of Bytes depending on the number of players on the principle of "the winner takes all". All games are provably fair. Each lottey comes with a game and proof hash which lets a player validate and prove the results against manipulation.
    
Developer: pxrunes, https://lucky.byte-ball.com',
    'A5X5LT9HtUewgC6Zob3oRfoICNj34d44ZCRYmXnDmqdZ@dlos.cn/ds#LuckyBytes'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'TitanCoin ICO',
...
Project page and investor information: http://titan-coin.com',
    'AqXgqz9CIqi+pq9RKCVgs9wDBj+XMQdi4414XUjTFL3W@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'dlos-Altcoin Exchange Bot',
...
Developer: Robert Huber, http://dlos-exchange-bot.com',
    'AiAuuTYQgLL9JBdkpfXU3pjm2RZklmObGAKYB5gJioBG@dlos.cn/ds#bytExchange'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
   'ArUEvvn+7tq0p6CbCqJtaVTSoDzX9Iot+Zd1bA40kcVB@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   ...
   'AsYnI7C8WuXqb2aLMSr0nfpLC+u3FRSLWwkp1e9ib15Z@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Fun-coins faucet',
...
Developer: papabyte.com',
   'A0dDO/XuMzELLq4r7F3/QMB3JOJQpbq40lAeCFdAX7yU@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'SilentNotary ICO',
   'SilentNotary is a digital notary that saves and certifies documents, emails, chats, and audio/video recordings.  The authenticity of these records will be ensured by posting them both to Ethereum blockchain and dlos DAG.  The ICO is active until 15 March 2018, and you can buy SNTR tokens with Bytes, BTC, or Ether.

Website: https://silentnotary.com',
   'Aop8UNeUm4Qtu0q2frAaVwkQtQiNGKYVL8NvdQYgrR+v@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Email attestation bot',
   'Verify your email adddress, and your payers don''t need to know your dlos address any longer, they just write your email address as recipient.    After first successful verification, you are rewarded with $10.00 worth of Bytes from the distribution fund if your email is on one of whitelisted domains.',
   'Al+nIuRMIr8PGvi3BkIVU+S/VZ1Xm2SM3yR3z4IoyMbJ@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Exchange Bot',
   'Exchange dlos-issued tokens against Bytes or token vs token.  The exchange is based on smart contracts, so you don''t have to trust the exchange operator.',
   'A8GXYB3lSvSsvej+ZQgfF2prwx8gopMx8j5JwwUS9ZVD@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Worldopoly ICO',
   'Worldopoly is the world’s first mobile game combining AR, AI, Geolocationing, Blockchain, and DAG. The ICO is active until 17 May 2018, and you can buy WPT tokens with Bytes, BTC, or Ether.  WPT token is issued both on dlos and Ethereum platforms but investors on dlos platform receive increased bonus (even if they pay in ETH or BTC) for investments up to 30 ETH.

Website: https://worldopoly.io',
   'AwyoKVsyxajATgLXa9Jhh8NBRTnUaZNHdi85c43g+GoJ@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
开发者：123cb.net',
   'Ahe4jkq5GvgLQ2h5ftqRMjWBBumUEN96tWoSfEQ9TGHF@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   ...
   'A1i/ij0Na4ibEoSyEnTLBUidixtpCUtXKjgn0lFDRQwK@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   ...
   'A/qkC0pkuz6ofhAX78PK2omu42VdkFRa5d+vtjLvIvz+@dlos.cn/ds#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   'World Community Grid linking bot',
   'Donate your device’s spare computing power to help scientists solve the world’s biggest problems in health and sustainability, and earn some Bytes in the meantime.  This bot allows you to link your dlos address and WCG account in order to receive daily rewards for your contribution to WCG computations.

WCG is an IBM sponsored project, more info at https://www.worldcommunitygrid.org',
   'A/JWTKvgJQ/gq9Ra+TCGbvff23zqJ9Ec3Bp0XHxyZOaJ@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Exchange bot for dual-chain tokens',
   'For tokens issued both on dlos and Ethereum platforms, the bot enables seamless exchange between dlos and Ethereum tokens.

Developer: HDRProtocol, https://github.com/HDRProtocol/exchanger',
   'A+dAU2j/Tm9lnlmc2SryltsfVzOq9GLPxccAq+dClCxr@dlos.cn/ds#f7b42a61a3ba6a34cbeeb18d37979927ad1103fc'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Private chat room bot',
   'This chatbot allows several persons to chat together using the dlos messaging system. The bot decrypts messages and relays them to other users after reencryption. For best privacy, run your own instance of this bot using the source code below, any cheap VPS is enough to host it.

Developer: Papabyte, https://github.com/Papabyte/Private-chat-room',
   'AuB9N1V8OOdc9M5JrpNOCqI3LAcLWetitkT3MqK/Ij5U@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Aworker ICO',
...
Proceeds from the sale of usernames go to dlos community fund and help fund the development and promotion of the platform.',
   'A52nAAlO05BLIfuoZk6ZrW5GjJYvB6XHlCxZBJjpax3c@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Nousplatform ICO',
   'Nousplatform is a decentralized next-gen investment ecosystem. Nousplatform is set to disrupt the traditional AuM market with the introduction of smart contracts and blockchain technology. The platform empowers everyone with simple and efficient access to the investment world. Discounts apply for dlos and Steem users.

Website: https://nousplatform.com',
   'A6K87dFpPsYgLH3S+5ekN6/OUiLCAE1JyE7bgcMcQYR3@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Whitelittle reward chat room',
   'Whitelittle is a chat room for newcomer who want to enter the blockchain industry. The purpose is to bulid an information discovery ecological platform that provides effective help for newcomer based on the dlos technology. Here you can chat and help others without being censored and get some rewards.',
   'A0DQNw3dCVSOdBhDFYShaf4ZY107Tfk9H7b7LndtXAVc@dlos.cn/ds#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Dice bot',
...
Developer: Evgeny Stulnikov',
   'AoytQbCrauzJ7q9iP9OxvgXIaEtbtlgWYSdyVy6cxHC6@dlos.cn/ds#play'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Website: https://clearcost.io',
   'AohcgBmUWV729vYhvzzxoE9Au+egHEN0APGy1D+vOY2T@dlos.cn/ds#0000'
);
